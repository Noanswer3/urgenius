            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="#welcome" class="active">LOGIN & JOIN</a></li>
                            <li><a href="#features">MY HISTORY</a></li>
                            <li><a href="#work-process">PILL SEARCH</a></li>
                            <li><a href="#testimonials">SEARCH PHARMACY</a></li>
                            <li><a href="#pricing-plans">REVIEW</a></li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                        <h1>서비스 소개하는 말머리<strong>PILL</strong><br>to grow up your <strong>business</strong></h1>
                        <p>나의 </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Prescription </h5>
                                <p>나의 처방전을 한 눈에 보기쉽게 관리해보세요.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.4s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Pill Search</h5>
                                <p>약의 이미지와 이름으로 정보를 제공받아보세요.</p>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
